"""Shared personal portfolio regression runner.

Used by both the pytest suite and the standalone CLI script to avoid
workflow logic drift. No network, provider SDKs, broker execution, or LLM.
"""
