...
If OpenClaw supports Markdown skill ingestion, point it at the hyphenated skill
docs under `skills/`. If OpenClaw supports subprocess tools, wire
...
OpenClaw owns data fetching, provider SDKs, credentials, MCP providers,
