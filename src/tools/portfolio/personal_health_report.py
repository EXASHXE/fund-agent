...
REASON_TRANSACTION_DERIVED_VALUATION = "transaction_derived_valuation"
REASON_RECONSTRUCTION_PARTIAL = "reconstruction_partial"
REASON_DIVIDEND_UNMODELED = "dividend_unmodeled"
REASON_UNMATCHED_REFUND = "unmatched_refund"
REASON_CONVERSION_UNVERIFIED = "conversion_unverified"
REASON_UNKNOWN_AMOUNT_SEMANTICS = "unknown_amount_semantics"
REASON_MISSING_FEE = "missing_fee"
...
VALID_REASON_CODES = frozenset({
    ...
    REASON_TRANSACTION_DERIVED_VALUATION,
    REASON_RECONSTRUCTION_PARTIAL,
    REASON_DIVIDEND_UNMODELED,
    REASON_UNMATCHED_REFUND,
    REASON_CONVERSION_UNVERIFIED,
    REASON_UNKNOWN_AMOUNT_SEMANTICS,
    REASON_MISSING_FEE,
})
