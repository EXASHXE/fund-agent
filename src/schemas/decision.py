...
- Every Decision MUST reference at least one evidence_id in rationale_anchor
...
class Decision:
    ...
    Attributes:
        ...
        rationale_anchor: Evidence IDs that directly support this decision.
            Must contain at least one evidence_id.
    ...
    def __post_init__(self) -> None:
        ...
        # Must reference at least one evidence_id in rationale_anchor
        if not self.rationale_anchor:
            raise ValueError(
