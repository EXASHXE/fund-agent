...
This is **fund-agent v0.10.4**, adding snapshot builders, report section extensions, CLI bridge, evidence graph extensions, and privacy hardening. Provider adapters
