...
from legacy.agents.tools.analysis_tools import register_analysis_tools
from legacy.agents.tools.kg_tools import register_kg_tools
from legacy.agents.tools.news_tools import register_news_tools
from legacy.agents.tools.strategy_tools import register_strategy_tools
from legacy.agents.tools.vector_tools import register_vector_tools
