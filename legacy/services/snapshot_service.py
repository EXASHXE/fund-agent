...
from src.infra.config.shared import dca_effective_date, now as shared_now
...
def perform_snapshot(config_path):
    ...
    from legacy.analysis.holdings import _is_business_day, _next_dca_date
    from src.infra.config.loader import load_portfolio_config
    from src.infra.config.schema import Purchase
