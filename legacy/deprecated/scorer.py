...
from legacy.analysis.factors import FactorMatrixBuilder
from legacy.analysis.holdings import compute_hhi
from legacy.analysis.loader import FundDataLoader
from legacy.analysis.metrics import MetricsCalculator
from legacy.deprecated.macro import MacroScorer
from legacy.deprecated.meso import MesoScorer
from legacy.deprecated.micro import MicroScorer
...
class FundAnalyzer:
    ...
    def build_agent_score_context(self, code: str, rule_score: Dict) -> Dict:
        """构造 agent 自主评分需要的证据包。"""
        from legacy.news.agent_context import build_score_judgment_context
